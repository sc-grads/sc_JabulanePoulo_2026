...
-- =============================================
CREATE OR ALTER PROCEDURE [timesheet].[CreateMigrationJob]
    @JobName NVARCHAR(128) = 'TimesheetMigration',
    @PackageName NVARCHAR(100) = 'TimesheetMigration1.dtsx',
    @FolderName NVARCHAR(100) = 'ETL',
    @ProjectName NVARCHAR(100) = 'TimesheetMigration1'
AS
BEGIN
    SET NOCOUNT ON;
